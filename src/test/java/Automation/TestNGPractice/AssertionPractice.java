...
//    @Test
    public void hardAssertPass(){
        ...
        Assert.assertTrue(true,"I will Pass if you provide Pass");
...
//    @Test
    public void softAssertFail(){
        ...
        softAssert.assertTrue(false,"I will Pass if you provide Fail");
        softAssert.assertTrue(false,"I will Pass if you provide Fail second");
...
//        Assert.assertTrue(expectedResult.equals(actualResult),"Casing not match");
    ...
    public void softAssertFail2(){
        ...
        System.out.println("I am from method Hard Assert fail but before Assert one Case Pass");
